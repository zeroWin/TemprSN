/**************************************************************************************************
  Filename:       ipd.c
  Revised:        $Date: 2011-05-20 16:26:11 -0700 (Fri, 20 May 2011) $
  Revision:       $Revision: 26054 $
 ...
 *
 * @param   pCmd - pointer to fast poll mode request structure
 ...
 *
 * @param   pCmd - pointer to fast poll mode response structure
 * @param   srcAddr - pointer to source address
 * @param   seqNum - sequence number of this command
 *
 * @return  none
